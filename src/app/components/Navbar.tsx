...
const Navbar = () => {
  ...
  return (
    <>
        <div className='fixed mt-0 right-0 w-11/12 translate-y-[-80%] dark:hidden mb-5'>
            <Image src={assets.header_bg_color} alt='' className='w-full' />
        </div>

        <nav 
            className={`fixed w-full mt-0 px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between mb-5
